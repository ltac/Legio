 ...
 *
 * Examples:
 * [1] call legio_zeusHC_fnc_spawnAVicDialogFactionChange; //Faction in the first index
 * [5] call legio_zeusHC_fnc_spawnAVicDialogFactionChange; //Faction in the fifth index
 *
 * Public: No
 */
