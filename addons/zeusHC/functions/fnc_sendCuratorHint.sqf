 ...
 *
 * Examples:
 * ["You're a zeus, congratulations"] call legio_zeusHC_fnc_sendCuratorHint
 * ["You're specifically a zeus, congratulations", objZeusMan] call legio_zeusHC_fnc_sendCuratorHint
 *
 * Public: Yes
 */
...
diag_log text format ["[LEGIO] - %1, sent to: %2", _message, _curators];
